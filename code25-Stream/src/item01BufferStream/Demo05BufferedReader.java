...
/*
BufferedReader:字符缓冲输入流        java.io.BufferedReader extends Reader
...
public class Demo05BufferedReader {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("F:\\item\\stream\\new.txt"));
        ...
        System.out.println(line);*/
        /*
        以上繁琐的重复代码，可以使用while循环，当等于null时表示没有内容啦
         */
        String line;
